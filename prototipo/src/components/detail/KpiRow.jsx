...
export function KpiRow({ r, periodo, moneda, mostrarPct = true }) {
  ...
  const columnas = mostrarPct ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1 sm:grid-cols-2 max-w-3xl mx-auto';

  return (
    <div className={`grid ${columnas} gap-4 mb-6`}>
      <div
