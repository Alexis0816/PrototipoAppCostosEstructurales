  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      ...
      >
        ...
        <p className="font-mono text-[1.4rem] sm:text-[1.75rem] font-bold text-blue-400">{fmt(r.proyeccion, moneda)}</p>
      </div>
      <div className="bg-navy-900 border border-navy-800 rounded-xl p-5">
        ...
        <p className="font-mono text-[1.4rem] sm:text-[1.75rem] font-bold text-slate-200">{fmt(r.total, moneda)}</p>
      </div>
      <div className="bg-navy-900 border border-navy-800 rounded-xl p-5">
        <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">Carga Prestacional/Mes</p>
        <p className="font-mono text-[1.4rem] sm:text-[1.75rem] font-bold text-amber-400">{fmt(r.carga, moneda)}</p>
      </div>
      <div className="bg-navy-900 border border-navy-800 rounded-xl p-5">
        <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">% Carga vs. Salario</p>
