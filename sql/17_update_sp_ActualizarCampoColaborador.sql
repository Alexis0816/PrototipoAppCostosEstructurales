-- ============================================================================
-- 17_update_sp_ActualizarCampoColaborador.sql  |  PeopleAnalytics
...
--
-- Cambio 2026-08-19: se agrega 'Utilidades' a la lista blanca (campo editable
-- nuevo, escrito a mano, PE/EC) y se exponen los nuevos Ingresos en el result set.
...
BEGIN
    ...
    IF @Campo NOT IN ('SueldoMensual', 'NSueldos', 'Vales', 'ComisionesMensuales', 'Grado', 'Utilidades')
    ...
    BEGIN TRY
        ...
        SET SueldoMensual       = CASE WHEN @Campo = 'SueldoMensual'       THEN @Valor ELSE SueldoMensual       END,
            ...
            Utilidades          = CASE WHEN @Campo = 'Utilidades'          THEN @Valor ELSE Utilidades          END
        ...
        SELECT
            SueldoMensual, NSueldos, Vales, ComisionesMensuales, Grado, Utilidades,
            BonoCPTarget, BonoCPMensual, CostoTotalMensual, CostoAnualML, CostoAnualUSD,
            Carga, PctCarga,
            CO_IngresoMensual, CO_IngresoAnual, PE_IngresoMensual, PE_IngresoAnual,
            EC_IngresoMensual, EC_IngresoAnual,
